...
export const appRouter = [
    {
        ...
        component: Main,
        children: [
            { path: 'index', title: '关于', name: 'about_index', component: resolve => { require(['./views/about/about.vue'], resolve); } }
        ]
    },
    ...
    */
    ...
    // },
    {
        ...
        component: Main,
        children: [
            { path: 'normalTable', title: '普通表格', name: 'normal-table', icon: 'ios-grid-view', component: resolve => { require(['./views/tables/normal-table.vue'], resolve); } },
